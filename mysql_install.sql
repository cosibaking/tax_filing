...
(1, 'basics', '基础设置', '站点名称', 'site_name', '金税管家', 'text', NULL, '{\"max\": 50, \"required\": true}', 10, '后台标题/LOGO文字', 0, 0, 0, 0, 1770737799),
...
(18, 'basics', '基础设置', '站点 LOGO', 'site_logo', '/attachment/upload/20260610/jinshui-logo.png', 'image', '{\"tip\": \"建议 200x200 PNG\", \"limit\": 1, \"accept\": \"image/*\"}', NULL, 70, '后台左上角 LOGO 图片', 0, 0, 0, 0, 1770737799),
