...
export const aboutIntro = {
  title: '关于金税管家',
  subtitle: '专注个人与小微商家的税务合规与申报服务，让经营者省心办税。',
  description:
    '金税管家面向个人经营者、自由职业者、电商卖家与内容创作者，提供从合规诊断、收入费用台账、申报提醒到月度对账单的一站式税务合规服务。我们以合法合规为前提，帮助用户把「收入分散、凭证零散、申报易漏」的痛点，转化为可执行、可追踪的合规流程。'
}
...
export const aboutMilestones: AboutMilestone[] = [
  {
    year: '服务定位',
    title: '聚焦个人税务合规',
    desc: '面向平台经营、自由职业、电商零售、知识付费等多元收入场景'
  },
  {
    year: '核心能力',
    title: '诊断 + 台账 + 申报',
