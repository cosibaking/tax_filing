...
export const appCases: AppCase[] = [
  {
    id: 'livestream',
    tag: '直播带货',
    title: '全职主播：多平台收入汇总申报',
    profile: '林女士 · 杭州 · 抖音+淘宝直播',
    income: '年综合收入约 86 万元',
    pain: '各平台代扣个税口径不一，年底汇算补税金额超预期，费用凭证零散难追溯。',
  ...
  },
  {
    id: 'creator',
    tag: '短视频',
    title: '知识博主：申报日历避免逾期风险',
    profile: '周先生 · 广州 · 知识付费+广告合作',
    income: '年综合收入约 58 万元',
    pain: '收入类型混杂（课程、广告、打赏），常错过申报截止日，产生滞纳金与信用隐患。',
    solution: '签约金税管家标准套餐，启用申报日历与到期提醒，顾问协助整理分类型收入明细。',
    outcome: '连续 12 个月申报按时完成，滞纳金为零；月度对账单可用于与 MCN 对账。',
    highlight: '申报节点自动提醒'
  },
  {
    id: 'ecommerce',
